...
export default function ComfyuiSetting({ config, onConfigChange }) {
  const { t } = useTranslation()
  const { setShowInstallDialog } = useConfigs()
  const [comfyUIStatus, setComfyUIStatus] = useState('unknown')
  const [isComfyUIInstalled, setIsComfyUIInstalled] = useState(false)
