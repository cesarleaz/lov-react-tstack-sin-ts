...
const UninstallProgressDialog = ({
  ...
  const [logs, setLogs] = useState([
    t('settings:comfyui.uninstallProgress.preparing')
  ])
  ...
  useEffect(() => {
    ...
    // Add event listeners
    window.addEventListener('comfyui-uninstall-progress', handleProgress)
    window.addEventListener('comfyui-uninstall-log', handleLog)
    window.addEventListener('comfyui-uninstall-error', handleError)
    return () => {
      // Remove event listeners
      window.removeEventListener('comfyui-uninstall-progress', handleProgress)
      window.removeEventListener('comfyui-uninstall-log', handleLog)
      window.removeEventListener('comfyui-uninstall-error', handleError)
    }
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-2">
              <div className="text-sm font-medium">
                {t('settings:comfyui.uninstallProgress.logTitle')}
              </div>
