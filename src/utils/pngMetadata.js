 ...
 */
function parsePNGMetadataChunks(buffer) {
  const chunks = []
 ...
 */
async function readPNGHeaderAndMetadata(filePath) {
 ...
 * 检查文件是否为PNG格式 (优化版本)
 */
export async function isPNGFile(filePath) {
  try {
    const response = await fetch(filePath, {
